...
class RpmCopyAction extends AbstractPackagingCopyAction<Rpm> {
    ...
    void startVisit(CopyAction action) {
        ...
        if ([task.preInstallFile, task.postInstallFile, task.preUninstallFile, task.postUninstallFile, task.debconfConfig, task.debconfTemplates].any()) {
            logger.warn('At least one of (preInstallFile|postInstallFile|preUninstallFile|postUninstallFile|debconfConfig|debconfTemplates) is defined ' +
