...
[![Build Status](https://travis-ci.org/nebula-plugins/gradle-ospackage-plugin.svg?branch=master)](https://travis-ci.org/nebula-plugins/projects/gradle-ospackage-plugin)
[![Coverage Status](https://coveralls.io/repos/nebula-plugins/gradle-ospackage-plugin/badge.svg?branch=masterservice=github)](https://coveralls.io/github/nebula-plugins/projects/gradle-ospackage-plugin?branch=master)
